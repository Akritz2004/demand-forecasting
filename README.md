...
ระบบพยากรณ์ความต้องการสินค้า (Demand Forecasting) ล่วงหน้าด้วย Machine Learning โดยใช้โมเดล **XGBoost** ในการวิเคราะห์ข้อมูลยอดขายย้อนหลัง (Time Series / Lags), ฤดูกาล (Seasonality) และโปรโมชั่น 
